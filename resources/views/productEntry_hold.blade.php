...
<script language='javascript' type='text/javascript'>
    $( document ).ready(function() {
        ...
        $('#showData').on('click',function(){
            $('#disappearing_div').show();
        });
        $('#expanddv').on('click',function(){
            var selectdiv="<div class='esdiv' id='seldiv'><select onchange='addBox(this);' id='nxt_selector'><option value='One'>One</option><option value='Two'>Two</option><option value='Three'>Three</option><option value='Four'>Four</option><option value='Five'>Five</option></select></div>"
            $('#seldiv').remove();
            $('#expanding_container').append("<div class='ediv'>another one</div>");
    ...
    function addBox(elem){
        var selectdiv="<div class='esdiv' id='seldiv'><select onchange='addBox(this);' id='nxt_selector'><option value='One'>One</option><option value='Two'>Two</option><option value='Three'>Three</option><option value='Four'>Four</option><option value='Five'>Five</option></select></div>"
        var new_box = "<div class='ediv'>"+elem.value+"</div>";
        $('#seldiv').remove();
