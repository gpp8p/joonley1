...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-10 offset-sm-1" style="padding: 10px;">
            <h2 class="page-heading" style="font-family: 'Fira Sans Condensed', sans-serif;">Upload images of your product here: </h2>
            <form method="post" action="{{ url('/images-save') }}"
                  enctype="multipart/form-data" class="dropzone" id="my-dropzone">
                {{ csrf_field() }}
                <div class="dz-message">
                    <div class="col-xs-8">
                        <div class="message" style="font-family: 'Fira Sans Condensed', sans-serif;">
